...
button2 = tkinter.Button(win, text="2", command=f2, )
button2.pack()

button3 = tkinter.Button(win, text="3", command=f3, )
button3.pack()

button4 = tkinter.Button(win, text="4", command=f4, )
button4.pack()
